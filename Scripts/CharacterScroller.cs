    ...
    public class CharacterScroller : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < VehicleManager.Instance.vehicles.Length; i++)
            {
                ...
                GameObject vehicle = (GameObject)Instantiate(VehicleManager.Instance.vehicles[i], vehicleCenterPoint, Quaternion.identity);//.Euler(originalRotation.x, originalRotation.y, originalRotation.z));
